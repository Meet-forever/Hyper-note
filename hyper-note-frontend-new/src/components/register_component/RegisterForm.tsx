    ...
    return (
        <div className="mx-auto max-w-sm w-full py-8 px-14 bg-opacity-70 rounded-xl z-10 bg-gray-100 shadow-lg ">
            <form className='flex flex-col text-xs sm:text-sm  justify-center items-center' onSubmit={handleSubmit}>
                ...
                <div className='text-center p-1 cursor-pointer font-semibold text-sm text-gray-700  w-full'>Already have an Account?<Link href="/login"><div className=" text-sky-700 hover:text-sky-500">Log In</div></Link></div>
            </form>
